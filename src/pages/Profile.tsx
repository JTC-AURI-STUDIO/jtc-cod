...
import { User, Key, Lock, Save, Loader2, Upload, Eye, EyeOff, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b border-border px-4 py-3 flex items-center justify-between">
        <Button variant="ghost" size="sm" onClick={() => navigate("/dashboard")} className="text-muted-foreground hover:text-primary">
          ...
          <span className="font-mono text-sm hidden sm:inline">Voltar</span>
        </Button>
        <div className="flex items-center gap-2">
          <User className="h-6 w-6 text-primary" />
          <span className="font-mono font-bold text-primary text-lg">Meu Perfil</span>
        </div>
